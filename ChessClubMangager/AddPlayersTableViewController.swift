...
//  ChessClubMangager
//
//  Created by Chris Stromberg on 10/21/16.
...
class AddPlayersTableViewController: UITableViewController {
    ...
    //Holds reference to the PlayerInfo business controller
    var player = Player()
    
    //Holds an array of playerEntity objects
    var playerList = Array<PlayerEntity>()
    
    //Holds a reference to the currently selected ClubEntity object.
    var clubEntity : ClubEntity!
    
    //Pass this varibale thru from perform segue from the clubListTable
