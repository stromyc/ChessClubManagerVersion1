...
//  ChessClubMangager
//
//  Created by Chris Stromberg on 9/25/16.
...
open class mmBusinessObject<T: NSManagedObject>
{
    ...
    func getEntities(sortedBy sortDescriptor:NSSortDescriptor?, matchingPredicate predicate:NSPredicate?) -> Array<T>
    {
        ...
        do {
            ...
            list = try self.managedObjectContext.fetch(request) as! Array<T>
    ...
    func checkRulesForEntity(_ entity: NSManagedObject) -> String?
    {
        return nil
    }
